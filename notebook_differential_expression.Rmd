...
params:
  project_name: 'Test'
  project_object: './dev/data/Test_nonMalignant_cluster_object.RDS'
...
```{r cell_annot_summary, eval = boolean_annotation}
...
if(auto_save) {
  ...
  saveRDS(all_markers, file = paste0('data/deg/', project_name, "_", input_step_name, '_deg_object.RDS'))
