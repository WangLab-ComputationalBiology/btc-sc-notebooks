...
input_reduction_name <- params$input_reduction_name
...
if(auto_save) {
  ...
  saveRDS(seurat_object, file = paste0('./data/', project_name, '_', input_reduction_name, '_reduction_object.RDS'))
