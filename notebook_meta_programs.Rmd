...
params:
  ...
  input_meta_programs: 'meta_programs.csv'
...
meta_programs <- meta_programs_db %>%
...
# Converting to list
meta_programs <- split(
  meta_programs$gene_marker,
  meta_programs$meta_program
  )
...
save_pheatmap(heat_plot, paste0('figures/meta/', project_name, '_', input_step_name,'_heatmap.pdf'))
...
if(auto_save) {
  ...
  saveRDS(seurat_object, file = paste0('data/', project_name, '_', input_step_name, '_meta_object.RDS'))
